      ...
      if (err) setError(true)
        ...
        const countryDataFinal: CountryStateWithDeltaDataType[] = countryDataTemp.map((el: CountryStateFormattedDataType, i: number) => {
          return {
            ...
            'Transgender(Individuals Vaccinated)': el['Transgender(Individuals Vaccinated)'],
            'Date': el.Date,
            'Delta 18-30 years (Age)': i === 0 ? el['18-30 years (Age)'] : el['18-30 years (Age)'] - countryDataTemp[i - 1]['18-30 years (Age)'],
            'Delta 30-45 years (Age)': i === 0 ? el['30-45 years (Age)'] : el['30-45 years (Age)'] - countryDataTemp[i - 1]['30-45 years (Age)'],
            ...
            '7-day Average 18-30 years (Age)': i < 7 ? el['18-30 years (Age)'] / (i + 1) : (el['18-30 years (Age)'] - countryDataTemp[i - 7]['18-30 years (Age)']) / 7,
            '7-day Average 30-45 years (Age)': i < 7 ? el['30-45 years (Age)'] / (i + 1) : (el['30-45 years (Age)'] - countryDataTemp[i - 7]['30-45 years (Age)']) / 7,
        ...
        const statesData: StateDataType[] = statesList.map((state: string) => {
          ...
          const stateDataFinal: CountryStateWithDeltaDataType[] = stateDataTemp.map((el: CountryStateFormattedDataType, i: number) => {
            return {
              ...
              'Transgender(Individuals Vaccinated)': el['Transgender(Individuals Vaccinated)'],
              'Date': el.Date,
              'Delta 18-30 years (Age)': i === 0 ? el['18-30 years (Age)'] : el['18-30 years (Age)'] - stateDataTemp[i - 1]['18-30 years (Age)'],
              'Delta 30-45 years (Age)': i === 0 ? el['30-45 years (Age)'] : el['30-45 years (Age)'] - stateDataTemp[i - 1]['30-45 years (Age)'],
              ...
              '7-day Average 18-30 years (Age)': i < 7 ? el['18-30 years (Age)'] / (i + 1) : (el['18-30 years (Age)'] - stateDataTemp[i - 7]['18-30 years (Age)']) / 7,
              '7-day Average 30-45 years (Age)': i < 7 ? el['30-45 years (Age)'] / (i + 1) : (el['30-45 years (Age)'] - stateDataTemp[i - 7]['30-45 years (Age)']) / 7,
