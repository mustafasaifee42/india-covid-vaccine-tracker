...
export interface CountryStateDataType {
  "18-44 Years(Individuals Vaccinated)": string;
  "45-60 Years(Individuals Vaccinated)": string;
  "60+ Years(Individuals Vaccinated)": string;
  AEFI: string;
  ...
  State: string;
  " Covaxin (Doses Administered)": string;
  "CoviShield (Doses Administered)": string;
  "Sputnik V (Doses Administered)": string;
...
export interface CountryStateFormattedDataType {
  "18-44 Years(Individuals Vaccinated)": number;
  "45-60 Years(Individuals Vaccinated)": number;
  "60+ Years(Individuals Vaccinated)": number;
  AEFI: number;
  ...
  " Covaxin (Doses Administered)": number;
  "CoviShield (Doses Administered)": number;
  "Sputnik V (Doses Administered)": number;
...
export interface CountryStateWithDeltaDataType {
  ...
  "Transgender(Individuals Vaccinated)": number;
  Date: Date;
  "Delta 18-44 Years(Individuals Vaccinated)": number;
  "Delta 45-60 Years(Individuals Vaccinated)": number;
  "Delta 60+ Years(Individuals Vaccinated)": number;
  ...
  "7-day Average 18-44 Years(Individuals Vaccinated)": number;
  "7-day Average 45-60 Years(Individuals Vaccinated)": number;
  "7-day Average 60+ Years(Individuals Vaccinated)": number;
